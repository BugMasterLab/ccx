...
export const messages: Record<SupportedLocale, Record<MessageKey, string>> = {
  ...
  id: {
    ...
    'addChannel.stripResponsesUserHint': 'Hapus field user yang dikirim ke upstream Responses API, tetapi tetap pertahankan prompt_cache_key.',
  ...
  'zh-CN': {
    ...
    'addChannel.stripResponsesUserHint': '移除发往 Responses API 上游的 user 字段，同时保留 prompt_cache_key。',
